...
class englishnovels extends StatelessWidget {
  const englishnovels({super.key});

  @override
  Widget build(BuildContext context) {
    List<String>textimg1=[
     "assets/images/en 1.png",
     "assets/images/en 2.png",
      "assets/images/en 3.png",
     "assets/images/en 4.png",
     "assets/images/en 5.png",
     "assets/images/en 6.png",
